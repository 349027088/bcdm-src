...
public interface BarcodeService extends IService<Barcode> {
     ...
     * 创建商品二维码
     *
     * @param goodsModel 需要创建二维码的商品
     * @return 创建成功额商品二维码编号
     * @throws Exception 创建二维码失败
     */
    String createBarcode(GoodsModel goodsModel) throws Exception;

    /**
     * 查询指定的商品信息
     *
     * @param goodsModel 需要查询的商品二维码
     * @return 查询到的商品信息
     * @throws Exception 查询商品信息失败
     */
    GoodsModel getGoodsByQRCode(GoodsModel goodsModel) throws Exception;
}
