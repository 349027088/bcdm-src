...
public class Management implements Serializable {
     ...
     * 管理员账号
     */
    @NotBlank(message = "管理员账号不能为空", groups = {RegisterGroup.class, GetInfoGroup.class})
    @Pattern(message = "管理员账号只能为字母或者数字", regexp = "^[A-Za-z0-9]+$", groups = {RegisterGroup.class, GetInfoGroup.class})
    @Length(max = 32, min = 6, message = "管理员账号长度为6-32位", groups = {RegisterGroup.class, GetInfoGroup.class})
